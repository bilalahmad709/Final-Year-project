        ...
        <div class="d-block text-dark text-center bg-white p-4">
            ...
            <div class=" w-100 overflow-scroll p-3 rounded-3">
                <div class="d-flex flex-column gap-4  ">
                    ...
                    $select = "select * from `cameras table`";
                    ...
                    ?>
                        ...
                        <div class="card d-flex justify-content-center align-items-center ">
                            ...
                            <div class="card-body d-flex flex-column justify-content-center align-items-center">
                                <h5 class="card-title text-dark"><?php echo $fetch['Camera Title']; ?></h5>
                            </div>
                            <a href="Delete product/Delete Camera.php?id=<?php echo $fetch['Id']; ?>" class="btn btn-danger mb-3">Delete Product</a>
                        </div>
                        <!-- Card 1 End -->
                    <?php
                    }
                    ...
                    <div class="d-md-flex  justify-content-md-between ">
                        ...
                        ?>
                            ...
                            <div class="card col-md-3 d-flex justify-content-center align-items-center col-sm-8">
                                ...
                                <a href="Delete product/Delete Camera.php?id=<?php echo $fetch['Id']; ?>" class="btn btn-outline-danger mb-3">Delete Product</a>
                            </div>
                            <!-- Card  End -->
                        <?php
                        }
